...
import Header from '../../component/header/Header'; // As explicitly asked to be conditionally included if following Guidance structure
...
export default function AboutLayout() {
  return (
    <>
      <Header />
      <div className="relative min-h-screen bg-[#05010b] text-white overflow-hidden pb-24 font-sans selection:bg-purple-500/30">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-4 md:px-8">
          ...
          >
            ...
            <motion.h1 variants={itemVariants} className="text-5xl lg:text-7xl font-bold tracking-tight mb-6 max-w-4xl z-10 leading-tight">
          ...
          >
            <h2 className="text-3xl font-semibold mb-8 text-center">The Challenges</h2>
                ...
                <div className="h-40 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chartData}>
                      ...
                      <Tooltip cursor={{fill: 'rgba(255,255,255,0.02)'}} contentStyle={{background:'#05010b', border:'1px solid rgba(255,255,255,0.1)', borderRadius:'8px'}} />
