...
import { UserPlus, ImagePlus, Save, Megaphone } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: "Sign up quickly to set up your personal creative hub and portfolio space.",
      icon: <UserPlus size={28} />
    },
    {
      stepNumber: 2,
      title: "Upload or Prompt",
      description: "Upload a photo of your craft, or simply write a prompt to let AI generate your post image.",
      icon: <ImagePlus size={28} />
    },
    {
      stepNumber: 3,
      title: "Generate & Save",
      description: "AI creates the perfect heartwarming caption and securely saves your finished content.",
      icon: <Save size={28} />
    },
    {
      stepNumber: 4,
      title: "Market Your Craft",
      description: "Use your generated assets and video ads to market your brand to a global audience.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
            Your Journey to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">Success.</span>
          </h2>
