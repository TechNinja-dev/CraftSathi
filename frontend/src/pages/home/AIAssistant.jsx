...
import { Cloud, BarChart3, PlaySquare } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-4 z-10 w-full relative">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-white text-center mb-6 relative z-10 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">always accessible.</span>
          </h2>
          
          <p className="text-gray-400 text-lg text-center max-w-xl mx-auto mb-10 relative z-10">
            We don't just generate content—we give you a dedicated workspace. Track your generation stats and securely access all your saved images, captions, and videos from your profile anytime.
          </p>

          <div className="flex justify-center mb-16 relative z-10">
            <Link 
              to="/profile" 
              className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full font-bold shadow-lg shadow-pink-500/20 hover:shadow-pink-500/40 hover:scale-105 transition-all duration-300"
            >
              View Portfolio
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full relative z-10">
            ...
            >
               ...
               <h3 className="text-white font-bold text-lg mb-2">Cloud Archive</h3>
               <p className="text-gray-400 text-sm">Every image and caption you generate is securely saved to your account. Never lose your creative work again.</p>
            </motion.div>
            ...
            >
               ...
               <p className="text-gray-400 text-sm">Store and manage your generated promotional video advertisements seamlessly alongside your other assets.</p>
            </motion.div>
            ...
            >
               ...
               <h3 className="text-white font-bold text-lg mb-2">Creator Analytics</h3>
               <p className="text-gray-400 text-sm">Check your dedicated profile dashboard to view total assets generated, total captions written, and creation stats.</p>
            </motion.div>
          </div>
