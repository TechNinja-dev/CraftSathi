...
export default function GlobalFAQ() {
  const faqData = [
    ...
    { question: "Is Etsy better than Amazon for handmade goods?", answer: "Etsy specifically caters to handmade and vintage items, usually yielding a more targeted audience, whereas Amazon handmade offers massive scale but higher competition." },
