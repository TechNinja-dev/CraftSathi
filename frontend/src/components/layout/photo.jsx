...
import { Loader2, Download, X, Maximize2, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="w-full max-w-6xl text-center relative z-10">
          ...
          >
            ...
            <p className="mt-6 text-lg text-gray-400 max-w-2xl mx-auto">
              Describe the image you want to create in detail and watch the AI bring it to life instantly.
            </p>
          </motion.div>
